...
[![Build Status](https://travis-ci.org/graphaware/neo4j-es.png)](https://travis-ci.org/graphaware/neo4j-es) | <a href="http://graphaware.com/products/" target="_blank">Downloads</a> | <a href="http://graphaware.com/site/neo4j-es/latest/apidocs/" target="_blank">Javadoc</a> | Latest Release: 2.2.5.35.0
...
The [first module](#neo4j2es) is a plugin to Neo4j (more precisely, a [GraphAware Transaction-Driven Runtime Module](https://github.com/graphaware/neo4j-framework/tree/master/runtime#graphaware-runtime)),
...
The [second module](#es2neo4j) is a plugin to Elasticsearch that can consult the Neo4j database during an Elasticsearch query to enrich
...
*  <a href="https://github.com/graphaware/neo4j-es" target="_blank">GraphAware Neo4j Elasticsearch Integration</a> (this project)
...
dependency above to 2.2.5.35.1-SNAPSHOT.

#### Note on Versioning Scheme

The version number has two parts. The first four numbers indicate compatibility with Neo4j GraphAware Framework.
 The last number is the version of the Elasticsearch Integration library. For example, version 2.2.5.35.1 is version 1 of the Elasticsearch Integration library
 compatible with GraphAware Neo4j Framework 2.2.5.35 (and thus Neo4j 2.2.5).
